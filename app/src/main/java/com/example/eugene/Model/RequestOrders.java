...
public class RequestOrders {
    ...
    HashMap<String, Orders> orderDetail;
    private long createDateTimeServer;

    public RequestOrders() {
    }

    public RequestOrders(int branchId, int orderType, int customerType, int subtotalItem, int isEnable, int isCancel,
                         String createByUser, String nameCustomer, String createDateTime,
                         String date, String time, String billDateTime, String status,
                         String notes, String cancelReason, String editedByUser,
                         String editDateTime,
                         double subtotalPrice, double nominalPayment, double change,
                         HashMap<String, Orders> orderDetail,
                         long createDateTimeServer) {
    ...
    public HashMap<String, Orders> getOrderDetail() {
        return orderDetail;
    }

    public void setOrderDetail(HashMap<String, Orders> orderDetail) {
        this.orderDetail = orderDetail;
    }
